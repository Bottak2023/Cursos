                ...
                <form className={'space-y-6 '} ref={form} onSubmit={sendEmail}>
                    ...
                    <div className={'space-y-6'}>
                        <div className={style.imgForm}>
                            <Image src="/favicon.png" width="250" height="150" alt="User" />
                        </div>
                    </div>
                    <br />
                    ...
                    <div className={'space-y-6'}>
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>PARTES DE LA TRASACCIÓN / PARTIES TO TRANSACTION</label>
                    ...
                    <div className={'space-y-6'}>
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>RUTA DE EXPORTACION TRAZADA</label>
                            <div className={'flex justify-around '}>
                                <div><input type="checkbox" className={'mr-5'} name="" id="" /><span>Yes</span></div>
                                <div><input type="checkbox" className={'mr-5'} name="" id="" /><span>No</span></div>
                            </div>
                        ...
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>SERVICIOS REQUERIDOS</label>
                            <div className={'flex justify-around '}>
                        ...
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>CARGA PELIGROSA</label>
                        ...
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>CARGA DE CREDITO ?</label>
                            <div className={'flex justify-around '}>
                                <div><input type="checkbox" className={'mr-5'} name="" id="" /><span>Si</span></div>
                                <div><input type="checkbox" className={'mr-5'} name="" id="" /><span>No</span></div>
                            </div>                        </div>
                        <div>
                            <label htmlFor="" className={'block relative bg-[#ffd900] text-center text-white my-3 p-2'}>MODALIDAD DE TRANSPORTE</label>
                            <div className={'flex justify-around '}>
