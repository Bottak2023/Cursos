...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (user && user !== undefined && userDB === null) { router.replace('/Admin') }
  }, [user, userDB])
      ...
      <source src='underwater.mp4' type="video/mp4" />
        ...
        <form className={`space-y-6 lg:space-y-3 w-[100%] rounded-[30px] max-w-[350px] z-10 lg:scale-110`} onSubmit={signInHandler} >
          <div className='w-full text-center flex justify-center'>
            <img src="/favicon.png" className='w-[200px] z-[50]' alt="User" />
          </div>
          <br />
          <div className='space-y-4 bg-[#00061860] p-5  rounded-[10px] lg:space-y-3'>
            ...
            <div>
              <label htmlFor="email" className="block mb-2 text-[16px] text-left font-medium text-[#ffd900]">Email</label>
            ...
            <div>
              <label htmlFor="password" className="block mb-2 text-[16px] text-left  font-medium text-[#ffd900]">Contraseña</label>
