        ...
        <div className="h-full "
            ...
            <div className=' w-screen pt-[50px] min-h-screen bg-gradient-to-t from-[#00061860] to-[#000618d1] flex flex-col justify-center items-center  z-10'>
                ...
                <div className='w-full text-center flex justify-center'>
                    <img src="/favicon.png" className='w-[300px] z-10' alt="User" />
                </div>
                ...
                <h5 className="text-[26px] text-center font-bold text-[#ffd900] z-[50]">CALCULADORA DE PESO VOLUMETRICO</h5>

                    
                    <div className='relative w-full flex justify-around  my-5'>
                        <button className={` py-2 w-full border-[#ffd900]  border-[2px] ${option === 'Dimension' ? 'bg-[#ffd900]' : ''}`} onClick={() => setOption('Dimension')}>POR DIMENSIONES</button>
                        <button className={`py-2 w-full border-[#ffd900] border-[2px] ${option === 'M3' ? 'bg-[#ffd900]' : ''}`} onClick={() => setOption('M3')}>POR M3</button>
                    </div>
