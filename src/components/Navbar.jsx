...
export default function BottomNavigation({ rol }) {
    ...
    return <>
        <nav className={`fixed  w-screen   transition-all ${pathname == '/Glosario' ? '  ' : ''} z-40  ${show ? 'top-0' : 'top-[-100px]'} transition-all  ${scrollY > 50 ? ' bg-[#272b3db7] lg:border-b lg:border-gray-200' : ''}`}>
            ...
            <div className="w-screen flex items-center justify-between mx-auto py-4 px-4 lg:px-8 ">
                <div className='flex items-center  md:hidden'>
                    <Link href="/" className="flex items-center">
                        <img src="/favicon.png" className="relative top-[3px] h-[50px]  mr-3" alt="Flowbite Logo" />
                    </Link>
                </div>
                ...
                {pathname !== '/Login' && pathname !== '/SignUp' && pathname !== '/Register' &&
                    <div className='relative  flex items-center  lg:hidden'>
                        {/* {
                            pathname === '/' && (user
                                ? <button className=' relative h-[35px]   z-50 bg-[#ffd900] mr-5 p-2 px-5 rounded-[5px] border lg:hidden' onClick={() => handleSignOut()}>Cerrar Sesión</button>
                                : <button className=' relative h-[35px] z-50 bg-[#ffd900]  mr-5 p-2 px-5 rounded-[5px] border lg:hidden' onClick={() => router.push('/Login')}>Iniciar Sesión</button>
                            )
                        } */}
                ...
                {pathname !== '/Login' && pathname !== '/SignUp' && pathname !== '/Register' && <div className="hidden w-screen lg:block md:w-auto " id="navbar-default">
                    ...
                    <ul className="list-none font-medium flex flex-col p-4 md:p-0 mt-0 rounded-lg md:flex-row md:items-center md:space-x-8  ">
                        <li onClick={() => handlerNavItem('Inicio')}>
                            <Link href='/#inicio' className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'Inicio' ? 'text-[#ffd900]' : 'text-white'}`}>{languaje === 'Español' ? 'Inicio' : 'Home'}</Link>
                        </li>
                        <li onClick={() => handlerNavItem('Servicios')}>
                            <Link href="/#cursos" className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'Servicios' ? 'text-[#ffd900]' : 'text-white'}`}> {languaje === 'Español' ? 'Cursos' : 'Services'}</Link>
                            {/* <div className={`absolute top-[90px] right-[20px] w-[350px]  bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  overflow-hidden ${navItem === 'Servicios' ? 'h-auto p-[20px]' : 'h-0 overflow-hidden'}`}>
                                <Link href='/#terrestre' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                ...
                                <Link href='/#maritimo' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/MARITIMO.png" className=" w-[35px]" alt="" />
                                    <span className="text-[12px] font-medium text-center">Transporte Maritimo</span>
                                </Link>
                                <Link href='/#aereo' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/AEREO.png" className=" w-[35px]" alt="" />
                                    <span className="text-[12px] font-medium text-center">Transporte Aereo</span>
                                </Link>
                                <Link href='/#despachos' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        ...
                        <li onClick={() => handlerNavItem('ServiciosEspecializados')}>
                            <Link href="/#testimonios" className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'ServiciosEspecializados' ? 'text-[#ffd900]' : 'text-white'}`}>{languaje === 'Español' ? 'Testimonios' : 'Specialized services'}</Link>
                            {/* <div className={`absolute top-[90px] right-[20px] w-[350px]  bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  overflow-hidden ${navItem === 'ServiciosEspecializados' ? 'h-auto p-[20px]' : 'h-0 overflow-hidden'}`}>
                                <Link href='/#proyecto' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/CARGA REFRIGERADA.png" className=" w-[35px]" alt="" />
                                    <span className="text-[12px] font-medium">Cargas Proyecto</span>
                                </Link>
                                <Link href='/#exportaciones' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/TERRESTRE.png" className=" w-[35px]" alt="" />
                                    <span className="text-[12px] font-medium text-center">Exportaciones</span>
                                </Link>
                                <Link href='/#farmaceutico' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/MARITIMO.png" className=" w-[35px]" alt="" />
                      ...
                      {/*    <li onClick={() => handlerNavItem('Herramientas')}>
                            <Link href="/#Recursos" className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'Herramientas' ? 'text-[#ffd900]' : 'text-white'}`} >{languaje === 'Español' ? 'Recursos' : 'Solutions IT'}</Link>
                           <div className={`absolute top-[90px] right-[20px] w-[350px]  bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  overflow-hidden ${navItem === 'Herramientas' ? 'h-auto p-[20px]' : 'h-0 overflow-hidden'}`}>
                                    <Link href='/Contenedores?item=maritimos' className='bg-[#ffd900]   flex flex-col items-center justify-around px-[5px] py-[5px] rounded-[7px]'>
                                    ...
                                    <Link href='/Contenedores?item=aereos' className='bg-[#ffd900]   flex flex-col items-center  justify-around px-[5px] py-[5px] rounded-[7px]'>
                                    ...
                                    <Link href='/Calculadora' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    ...
                                    <Link href='/Impuestos' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    ...
                                    <Link href='/#home' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        ...
                        <li onClick={() => handlerNavItem('Nosotros')}>
                            <Link href="/#acerca" className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'Nosotros' ? 'text-[#ffd900]' : 'text-white'}`}>{languaje === 'Español' ? 'Acerca de' : 'About Us'}</Link>
                            {/* <div className={`absolute top-[90px] right-[20px] w-[350px]  bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  overflow-hidden ${navItem === 'Nosotros' ? 'h-auto p-[20px]' : 'h-0 overflow-hidden'}`}>
                                <Link href='/#Nosotros' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/NOSOTROS.png" className=" w-[35px]" alt="" />
                                    <span>Nosotros</span>
                                </Link>
                                <Link href='/#PorQueElegirnos' onClick={() => { setNav(false); setSeeMore('PORQUE') }} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/NOSOTROS.png" className=" w-[35px]" alt="" />
                                    <span>Por que nosotros?</span>
                                </Link>
                            </div> */}
                        </li>
                        <li onClick={() => handlerNavItem('Contactos')}>
                            <Link href="/#contactos" className={`block py-2 pl-3 pr-4 text-[14px] rounded   md:border-0  md:p-0   transition-all hover:text-[#ffd900] cursor-pointer z-30 ${navItem === 'Contactos' ? 'text-[#ffd900]' : 'text-white'}`}>{languaje === 'Español' ? 'Contactos' : 'About Us'}</Link>
                            {/* <div className={`absolute top-[90px] right-[20px] w-[350px]  bg-blue-950  grid grid-cols-2 gap-[20px]  rounded-2xl z-20  overflow-hidden ${navItem === 'Nosotros' ? 'h-auto p-[20px]' : 'h-0 overflow-hidden'}`}>
                                <Link href='/#Nosotros' className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                                    <img src="/icons/NOSOTROS.png" className=" w-[35px]" alt="" />
                                    <span>Nosotros</span>
                        ...
                        {/* <li>
                            {
                                pathname !== '/Login' && pathname !== '/SignUp' && pathname !== '/Register' && (user
                                    ? <button className=' relative h-[35px]  z-50 bg-[#ffd900] p-2 px-5 rounded-[5px] border hidden lg:block' onClick={() => handleSignOut()}>{languaje === 'Español' ? 'Cerrar Sesión' : 'Logout'}</button>
                                    : <button className=' relative h-[35px] z-50 bg-[#ffd900]   p-2 px-5 rounded-[5px] border hidden lg:block' onClick={() => router.push('/Login')}>{languaje === 'Español' ? 'Iniciar Sesión' : 'Login'}</button>
                                )
                            }
                        </li> */}
                        ...
                        {/* <div className='relative w-[100px]'>
                            ...
                            {pathname !== '/Login' && pathname !== '/SignUp' && pathname !== '/Register' && <SelectSimple arr={['Español', 'English']} bg='bg-[#ffd900] text-black border-[#ffffff38]' position={'absolute left-0 px-4'} click={handlerClickSelect} defaultValue={languaje} />}
        ...
        <div className={`fixed top-0 w-screen lg:w-screen lg:border-r-8 overflow-auto  bg-gradient-to-tr from-[#111a3377] via-[#111a3352] to-[#111a3344] h-screen transition-all	z-50  py-[20px] pb-[50px] ${nav ? 'left-0  ' : 'left-[-100vw] '} z-50`}
            // style={{
            ...
            {/*-------------------------------------------- MOBILE--------------------------- */}
            <div className='pt-[50px] flex flex-col justify-around  h-full'>

                <Link href='/' onClick={() => setNav(false)}>
                    <h3 className="flex justify-center items-center text-black text-[12px] font-medium pt-2 pl-5 m-0 border border-[#ffffff38] bg-[#ffd900] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">
                ...
                <Link href='/#cursos' onClick={() => setNav(false)}>
                    <h3 className="flex justify-center items-center text-black text-[12px] font-medium pt-2 pl-5 m-0 border border-[#ffffff38] bg-[#ffd900] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">
                        {languaje === 'Español' ? 'CURSOS' : 'HOME'}
                        {/* <svg className="ml-10 rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg> */}
                    </h3>
                </Link>
                <Link href='/#testimonios' onClick={() => setNav(false)}>
                    <h3 className="flex justify-center items-center text-black text-[12px] font-medium pt-2 pl-5 m-0 border border-[#ffffff38] bg-[#ffd900] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">
                        {languaje === 'Español' ? 'TESTIMONIOS' : 'HOME'}
                        {/* <svg className="ml-10 rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg> */}
                    </h3>
                </Link>
                <Link href='/#acerca' onClick={() => setNav(false)}>
                    <h3 className="flex justify-center items-center text-black text-[12px] font-medium pt-2 pl-5 m-0 border border-[#ffffff38] bg-[#ffd900] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">
                        {languaje === 'Español' ? 'ACERCA DE' : 'HOME'}
                        {/* <svg className="ml-10 rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg> */}
                    </h3>
                </Link>
                <Link href='/#contactos' onClick={() => setNav(false)}>
                    <h3 className="flex justify-center items-center text-black text-[12px] font-medium pt-2 pl-5 m-0 border border-[#ffffff38] bg-[#ffd900] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">
                        {languaje === 'Español' ? 'CONTACTOS' : 'HOME'}
                        {/* <svg className="ml-10 rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg> */}
                    </h3>
                ...
                <div className='grid grid-cols-2 gap-[20px] p-[20px] pt-[10px]'>
                    <Link href='/#Nosotros' onClick={() => setNav(false)} className='bg-[#ffd900]    flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        <img src="/icons/NOSOTROS.png" className=" w-[35px]" alt="" />
                ...
                {/* <div className='grid grid-cols-2 gap-[20px] p-[20px] pt-[10px]'>
                    <Link href='/#terrestre' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        <img src="/icons/TERRESTRE.png" className=" w-[35px]" alt="" />
                        <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Transporte Terrestre' : 'Ground transportation'}</span>
                    </Link>
                    <Link href='/#maritimo' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        <img src="/icons/MARITIMO.png" className=" w-[35px]" alt="" />
                        <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Transporte Maritimo' : 'Marine transport'}</span>
                    </Link>
                    <Link href='/#aereo' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        <img src="/icons/AEREO.png" className=" w-[35px]" alt="" />
                        <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Transporte Aereo' : 'Air Transport'}</span>
                    </Link>
                    <Link href='/#despachos' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                        <img src="/icons/DESPACHO ADUANERO.png" className=" w-[35px]" alt="" />
                ...
                <div className='grid grid-cols-2 gap-[20px] p-[20px] pt-[10px] border-[#ffffff38] border-b-[5px] mb-10'>
                    ...
                    {/* <Link href='/SolucionesIT' onClick={() => setNav(false)}>
                        <h3 className="text-black text-[12px] font-medium pt-2 pl-5 m-0 bg-[#ffd900]  border border-[#ffffff38] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">{languaje === 'Español' ? 'SOLUCIONES IT' : 'IT SOLUTIONS'}</h3>
                    </Link> */}

                    {/* <div className='relative grid grid-cols-2 gap-[20px] p-[20px] pt-[10px] border-[#ffffff38] border-b-[5px] mb-10'>
                        <Link href='/Calculadora' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                            <img src="/icons/CALCULADORA DE PESO CARGABLE.png" className=" w-[35px]" alt="" />
                        ...
                        <Link href='/Impuestos' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                            <img src="/icons/CALCULADORA DE IMPUESTOS.png" className=" w-[35px]" alt="" />
                            <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Calculadora de impuestos' : 'tax calculator'} </span>
                        </Link>
                        <Link href='/Tracking' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                            <img src="/icons/DIRECCION.png" className=" w-[35px]" alt="" />
                ...
                {/* <Link href='/Experiencia' onClick={() => setNav(false)}>
                    <h3 className="text-black text-[12px] font-medium pt-2 pl-5 m-0 bg-[#ffd900]  border border-[#ffffff38] text-center px-[5px] py-[5px] rounded-[7px] mx-[20px] my-[15px]">{languaje === 'Español' ? 'TESTIMONIOS' : 'EXPERIENCE'}</h3>
                </Link> */}
                {/* <div className='relative grid grid-cols-2 gap-[20px] p-[20px] pt-[10px] border-[#ffffff38] border-b-[5px] mb-10'>
                    <Link href='/Experiencia' onClick={() => setNav(false)} className='bg-[#ffd900] flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                    ...
                    <Link href='/Experiencia#testimonios' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center justify-around px-[5px] py-[5px] rounded-[7px]'>
...
{/* 
                    <div className='relative grid grid-cols-2 gap-[20px] p-[20px] pt-[10px] '>
                        <Link href='/Contenedores?item=maritimos' onClick={() => setNav(false)} className='bg-[#ffd900] flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
                            <img src="/icons/TIPOS DE CONTENEDORES MARITIMOS.png" className=" w-[35px]" alt="" />
                            <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Contenedores maritimos' : 'Maritime containers'}</span>
                        </Link>
                        <Link href='/Contenedores?item=aereos' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center justify-around px-[5px] py-[5px] rounded-[7px]'>
                            <img src="/icons/TIPOS DE CONTENEDORES AEREOS.png" className=" w-[35px]" alt="" />
                            <span className="text-[12px] font-medium text-center">{languaje === 'Español' ? 'Contenedores aereos' : 'Air containers'}</span>
                        </Link>
                        <Link href='/Glosario' onClick={() => setNav(false)} className='bg-[#ffd900]   flex flex-col items-center px-[5px] py-[5px] rounded-[7px]'>
